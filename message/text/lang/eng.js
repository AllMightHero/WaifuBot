...
Otros usos: *play*
Uso: *${prefix}ytmp3* nombre de la cancion.

2. *${prefix}video*
Descargar video de Youtube, (videos con alta duracion fallan)
Otros usos: -
Uso: *${prefix}ytmp4* nombre del video.
...
Otros usos: *del*
Uso: Responder a los mensajes que desea eliminar con el texto *${prefix}delete*.
